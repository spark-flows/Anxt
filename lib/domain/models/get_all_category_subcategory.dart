...
GetAllFileAndFolder getAllFileAndFolderFromJson(String str) => GetAllFileAndFolder.fromJson(json.decode(str));

String getAllFileAndFolderToJson(GetAllFileAndFolder data) => json.encode(data.toJson());
...
class GetAllFileAndFolder {
    ...
    factory GetAllFileAndFolder.fromJson(Map<String, dynamic> json) => GetAllFileAndFolder(
...
class GetAllFileData {
    ...
    factory GetAllFileData.fromJson(Map<String, dynamic> json) => GetAllFileData(
        docs: List<GetAllFileDoc>.from(json["docs"].map((x) => GetAllFileDoc.fromJson(x))),
...
class GetAllFileDoc {
    ...
    factory GetAllFileDoc.fromJson(Map<String, dynamic> json) => GetAllFileDoc(
        ...
        subCategories: List<GetAllFileDoc>.from(json["subCategories"].map((x) => GetAllFileDoc.fromJson(x))),
