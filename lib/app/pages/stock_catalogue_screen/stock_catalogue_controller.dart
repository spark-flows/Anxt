...
class StockCatalogueController extends GetxController {
  StockCatalogueController(this.stockCataloguePreneter);

  StockCataloguePreneter stockCataloguePreneter;
  ...
  Future<void> postGetProductList({required categoryId}) async {
    ...
    var response = await stockCataloguePreneter.postGetProductList(
      isLoading: true,
      category: categoryId,
      page: 1,
      limit: 20,
