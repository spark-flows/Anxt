...
ThemeData themeData(BuildContext context) => ThemeData(
  ...
  datePickerTheme: DatePickerThemeData(rangeSelectionBackgroundColor: ColorsValue.appColor.withAlpha(50)),
...
ThemeData darkThemeData(BuildContext context) => ThemeData(
  ...
  colorScheme: ColorScheme.dark(surface: Colors.white, primary: const Color.fromRGBO(23, 166, 221, 1)),
  inputDecorationTheme: InputDecorationTheme(
    fillColor: Colors.grey,
    hintStyle: TextStyle(color: Get.theme.hintColor.withOpacity(.3)),
    border: const OutlineInputBorder(
      borderRadius: BorderRadius.all(Radius.circular(14)),
      borderSide: BorderSide(color: Color.fromARGB(255, 209, 209, 209), width: 1.5),
    ),
    ...
    errorBorder: const OutlineInputBorder(
      borderRadius: BorderRadius.all(Radius.circular(14)),
      borderSide: BorderSide(color: Color.fromRGBO(240, 151, 149, 1), width: 1.5),
    ),
    focusedBorder: const OutlineInputBorder(
      borderRadius: BorderRadius.all(Radius.circular(14)),
      borderSide: BorderSide(color: Color.fromARGB(30, 27, 83, 244), width: 1.5),
    ),
  ),
